# intercraft Philosophy

## Purpose
Agent-native architecture patterns — design, review, and audit for agent-first applications.

## North Star
Advance intercraft through small, testable changes aligned to its core mission: Agent-native architecture patterns — design, review, and audit for agent-first applications.
